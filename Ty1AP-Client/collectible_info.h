...
const LevelCollectibleInfo C3Info(
    ...
    {  },
    { 
        {"Golden Cog 1", "Underwater near volcano thunder egg and warp flower cog"},
        {"Golden Cog 2", "On moving platform"},
        {"Golden Cog 3", "On large platform near skull rock at start"},
        {"Golden Cog 4", "In the middle of sea mines on opal path leading to opal collector"},
